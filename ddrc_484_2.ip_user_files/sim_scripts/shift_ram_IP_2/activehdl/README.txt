...
#
# Generated by export_simulation on Mon May 06 23:22:29 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './shift_ram_IP_2.sh' script.

./shift_ram_IP_2.sh -reset_run
...
./shift_ram_IP_2.sh -noclean_files

For more information on the script, please type './shift_ram_IP_2.sh -help'.
