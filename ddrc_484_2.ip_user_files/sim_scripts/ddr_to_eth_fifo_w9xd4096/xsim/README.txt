...
#
# Generated by export_simulation on Mon May 06 16:35:19 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ddr_to_eth_fifo_w9xd4096.sh' script.

./ddr_to_eth_fifo_w9xd4096.sh -reset_run
...
./ddr_to_eth_fifo_w9xd4096.sh -noclean_files

For more information on the script, please type './ddr_to_eth_fifo_w9xd4096.sh -help'.
