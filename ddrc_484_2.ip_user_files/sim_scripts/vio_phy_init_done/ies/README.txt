...
#
# Generated by export_simulation on Sun May 05 16:01:32 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './vio_phy_init_done.sh' script.

./vio_phy_init_done.sh -reset_run
...
./vio_phy_init_done.sh -noclean_files

For more information on the script, please type './vio_phy_init_done.sh -help'.
